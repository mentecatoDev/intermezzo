...
for m in range(0,400):
    ...
    list=[ turtle.pd(), turtle.stamp(), turtle.pu(),turtle.color(colors),turtle.fd(1+m/2),
          turtle.rt(120), turtle.color(colors), turtle.fd(1),turtle.lt(45),turtle.color(colors),
          turtle.fd(1+m/2),turtle.rt(90),turtle.color(colors), turtle.bk(1+m/2)]
